...
class ArrayTest < Minitest::Homework
  ...
  #.uniq is creating a set of unique elements in an array.
...
#returns first element in an array and deletes that element from the array
  def test_shift
...
#returns first last in an array and deletes that element from the array
  def test_pop
